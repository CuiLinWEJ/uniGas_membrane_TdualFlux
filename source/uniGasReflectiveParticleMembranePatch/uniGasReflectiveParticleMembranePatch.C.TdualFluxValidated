    ...
    if(d > 0) // processor boundary
    {
        ...
        writeLocalMembraneForce();
            ...
            else
            {
                ...
                // Transmission statistics: master side to slave side
                ++nTransAtoB_;
    ...
    else if (d < 0) // cyclic (non-processor boundary)
    {
        ...
        writeLocalMembraneForce();
            ...
            else
            {
                ...
                // Transmission statistics: slave side to master side
                ++nTransBtoA_;
